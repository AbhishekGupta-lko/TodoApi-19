...
namespace TodoApi.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        {
            if (!string.IsNullOrEmpty(product.ProductName) && !string.IsNullOrEmpty(product.ProductDescription) && product.ProductCost != null && product.ProductStock != null)
            {
        ...
        [HttpPost]
        [Route("UpdateProduct")]
        public async Task<ActionResult<IEnumerable<Product>>> Update(int id, [FromBody] Product product)
        {
